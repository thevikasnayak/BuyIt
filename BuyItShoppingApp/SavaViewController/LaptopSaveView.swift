...
class LaptopSaveView: UIViewController,UIImagePickerControllerDelegate, UINavigationControllerDelegate
{
    ...
    @IBAction func btnSave(_ sender: Any)
    {
        ...
        if item == nil {
            ...
            let entityDescription = NSEntityDescription.entity(forEntityName: "ItemLaptop", in: pc)
            
            let item = ItemLaptop(entity: entityDescription!, insertInto: pc)
