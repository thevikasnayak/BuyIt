...
class MobileSaveView: UIViewController,UIImagePickerControllerDelegate, UINavigationControllerDelegate
{
    ...
    @IBAction func btnSave(_ sender: Any)
    {
        ...
        if item == nil {
            ...
            let entityDescription = NSEntityDescription.entity(forEntityName: "ItemMobile", in: pc)
            
            let item = ItemMobile(entity: entityDescription!, insertInto: pc)
