...
class CameraSaveView: UIViewController,UIImagePickerControllerDelegate, UINavigationControllerDelegate

{
    ...
    @IBAction func btnSave(_ sender: Any)
    {
        ...
        if item == nil {
            ...
            let entityDescription = NSEntityDescription.entity(forEntityName: "ItemCamera", in: pc)
            
            let item = ItemCamera(entity: entityDescription!, insertInto: pc)
