...
class MobileCollectionView: UICollectionViewController, NSFetchedResultsControllerDelegate

{
    ...
    func fetchRequest() -> NSFetchRequest<NSFetchRequestResult> {
        ...
        let fetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: "ItemMobile")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Cell", for: indexPath) as! MobileCollectionViewCell
        
        let item = frc.object(at: indexPath) as! ItemMobile
